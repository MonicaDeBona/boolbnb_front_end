        ...
        searchApartments() {
            axios.get(this.urlAddress + "/api/apartments/", {
                ...
                .then((response) => {
                    ...
                    //ottengo le coordinate degli appartamenti ciclando sugli appartamenti
                    this.store.apartments.forEach(apartment => {
                    const coordinates = { 
                        latitude: apartment.latitude, 
                        longitude: apartment.longitude,
                        id: apartment.id, //agggiungo l'id per capire di quale appartamento prendere le coordinate
                    };
                    this.store.apartmentsCoordinates.push(coordinates);
                    });
